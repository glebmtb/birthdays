...
public class ContactListViewImpl extends LayoutContainer implements ContactListPresenter.ContactView {
  ...
  private Grid<ContactListDTO> createGrid() {
    ...
    columns.add(new ColumnConfig(ContactListDTO.NICKNAME, localization.nickname(), 30));
    columns.add(new ColumnConfig((ContactListDTO.LAST_NAME), localization.lastName(), 100));
    columns.add(new ColumnConfig(ContactListDTO.FIRST_NAME, localization.firstName(), 100));
    columns.add(new ColumnConfig((ContactListDTO.MIDDLE_NAME), localization.middleName(), 100));
